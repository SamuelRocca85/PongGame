...
void menu()
{
    ...
    while (true)
    {
        ...
        cout << "Controles:";
        gotoxy(27, 3);
        cout << "S: Desplazarse hacia abajo";
        gotoxy(27, 4);
        cout << "W: Desplazarse hacia arriba";
        gotoxy(27, 5);
        cout << "Enter: Aceptar/Seleccionar";
...
void game()
{
    ...
    startkey;
    gotoxy(14, 1);
    cout << "   Consigue 7 puntos para ganar!         ";
    ...
    while (true)
    {
        ...
        if (j1.getPuntos() == 7 || j2.getPuntos() == 7)
        {
            ...
            ball.reset();
            gotoxy(2, 2);
            cout << "score: " << j1.getNick() << ": " << j1.getPuntos() << " - " << j2.getNick() << ": " << j2.getPuntos();
            gotoxy(2, 4);
            waitkey;
            rlutil::cls();
            j1.reset();
...
{
    gotoxy(38, 1);
    cout << "Pulsa \"q\" en cualquier momento para regresar al menu";
    char key = 'a';
    while (key != 'q')
    {
        record.print();
...
void setName(Player *p, int n)
{
    ...
    {
        gotoxy(2, 3);
        cout << "Ingrese el nickname del jugador " << n << " (maximo 12 caracteres): ";
        cin >> name;
        if (name.length() > 12)
        {
            rlutil::cls();
            gotoxy(2, 1);
            cout << "Error: el nickname no debe contener mas de 12 caracteres! Vuelve a intentar";
        }
